...
public abstract class WebUtils {
	...
	public static String findParameterValue(Map<String, ?> parameters, String name) {
		...
		if (value instanceof String[]) {
			...
			String val =  (values.length > 0 ? values[0] : null);
	...
	public static String getParameterValue(ServletRequest request, String name){
		return findParameterValue(request, name);
	}
	
	public static String getParameterValue(ServletRequest request, String name,String def){
	...
	public static Integer getParameterIntegerValue(ServletRequest request, String name){
		return getParameterIntegerValue(request,name,null);
	}
	
	public static Integer getParameterIntegerValue(ServletRequest request, String name,Integer def){
	...
	public static Double getParameterDoubleValue(ServletRequest request, String name){
		return getParameterDoubleValue(request,name,null);
	}
	
	public static Double getParameterDoubleValue(ServletRequest request, String name,Double def){
		String value = getParameterValue(request,name);
		if(StringUtils.hasText(value)){
	...
	public static Float getParameterFloatValue(ServletRequest request, String name){
		return getParameterFloatValue(request,name,null);
	}
	
	public static Float getParameterFloatValue(ServletRequest request, String name,Float def){
		String value = getParameterValue(request,name);
		if(StringUtils.hasText(value)){
