 ...
 * @since 2.0
 * @version $Id: DateUtils.java 1066645 2011-02-02 21:55:15Z niallp $
 */
...
// ----------------- Fix for LANG-440 ---------------------- END ---------------
  ...
  public static long getFragmentInMilliseconds(Calendar calendar, int fragment) {
	...
	private static SimpleDateFormat ISO_DATETIME_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	...
	public static Date parseDayTime(String day) {
		try {
			if(!StringUtils.hasText(day)){
				return null;
			}
			return ISO_DATETIME_FORMAT.parse(day);
		} catch (ParseException ex) {
			throw new IllegalArgumentException(ex);
		}
	}
	 ...
	 * @return
	 */
	public static Date day(Date time,int day){
		Calendar calendar = Calendar.getInstance();
